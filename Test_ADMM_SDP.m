...
% Read data (low_rank matrix generated by Matlab)
% filename1 = '/Users/zhouhaobang/Desktop/Dissertation/Code/ADMM_SDP/Example/30_by_30/rank_3_B_30.csv';
% filename1 = '/Users/zhouhaobang/Desktop/Dissertation/Code/ADMM_SDP/Example/low_rank_10_B.csv';
% B = csvread(filename1);

% filename2 = '/Users/zhouhaobang/Desktop/Dissertation/Code/ADMM_SDP/Example/30_by_30/rank_3_B_new_30.csv';
% filename2 = '/Users/zhouhaobang/Desktop/Dissertation/Code/ADMM_SDP/Example/low_rank_10_B_new.csv';
% B_new = csvread(filename2);

% Generate a matrix
[B, B_new, rank_B] = Create_low_rank_matrix(2, 300, 0.4);    
[m_h,n_h]=size(B_new);
...
% y2 = sr_6;
% y3 = sr_9;
% plot(x,y1,'r', 'Displayname', 'SR=0.3')
% legend
% hold on
% plot(x,y2,'g', 'Displayname', 'SR=0.6')
% legend
% hold on
% plot(x,y3,'b', 'Displayname', 'SR=0.9')
% legend
% hold on
% xlim([0 10])
% xlabel('Rank')
...
% y1 = [1.31, 1.71, 1.62, 1.82, 2.32, 13, 41];
